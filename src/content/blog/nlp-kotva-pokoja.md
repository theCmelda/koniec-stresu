...
leadMagnet:
  title: "Pokoj je len jedno gesto <em>ďaleko.</em>"
  description: Bezplatné audio s vedenou nahrávkou na vytvorenie tvojej osobnej kotvy pokoja. PDF s celým postupom.
...
- Čo je **NLP kotva pokoja** a prečo funguje cez nervový systém
- Ako sa líši **NLP technika anchoring** od bežnej relaxácie
- Ako si vytvoríš vlastné gesto pre stav pokoja pomocou **anchoring NLP**
- Kedy použiť **kotva pokoja meditácia** a kedy stačí 10 sekúnd
- Ako trénovať kotvu tak, aby fungovala aj v reálnom strese
...
- výdych ústami alebo nosom na 6 až 8 dôb
- 5 opakovaní
- potom vyvolaj spomienku pokoja
- až na vrchole stavu aktivuj gesto
