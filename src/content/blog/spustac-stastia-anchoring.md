...
- ako funguje **spúšťač šťastia** cez nervovú sústavu, pamäť a asociácie
- čo je **NLP anchoring** a prečo nejde o magické myslenie, ale o tréning pozornosti a tela
- ako si zapnúť pokoj cez gesto, dych, vôňu alebo zvuk
- ako vytvoriť **anchoring pozitívny stav**, ktorý sa dá použiť pred výkonom, rozhovorom alebo spánkom
- prečo regulácia, bezpečie a neuroplasticita rozhodujú o tom, či technika ostane len pekný nápad alebo reálny nástroj
