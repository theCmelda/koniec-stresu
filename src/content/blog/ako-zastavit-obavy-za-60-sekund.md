---
title: "Ako zastaviť obavy za 60 sekúnd: trik, ktorý okamžite vypne úzkostné myšlienky"
description: Ako zastaviť obavy za 60 sekúnd pomocou KBT, uzemnenia 5-4-3-2-1 a dychu. Praktická technika na úzkostné myšlienky.
...
1. Nadýchni sa nosom.
2. Hneď pridaj krátky druhý nádych nosom.
3. Pomaly vydýchni ústami.
Tento typ dychu pomáha vyprázdniť prebytočný oxid uhličitý a spomaliť fyziologické napätie. Neurovedec Andrew Huberman ho často opisuje ako jeden z najrýchlejších spôsobov, ako znížiť stresovú aktiváciu v tele.
...
2. Vráť sa k zmyslom.
3. Predĺž výdych.
4. Urob jeden konkrétny krok, ak je potrebný.
5. Ak krok neexistuje, odlož riešenie na presný čas.
...
1. Vyber si jednu obavu, ktorá sa ti často vracia.
2. Napíš ju vetou: „Mám myšlienku, že...“
3. Použi **5-4-3-2-1**.
4. Urob 2 kolá **fyziologického vzdychu**.
5. Zapíš najbližší malý krok, alebo si urči čas, kedy sa k tomu vrátiš.
