...
- Ako funguje **denník vďačnosti ako začať** bez tlaku a viny.
- Prečo **denník vďačnosti** ovplyvňuje nervový systém, dych a pocit bezpečia.
- Ako spraviť 10-minútové **vďačnosť cvičenie** na osobný zoznam zdrojov šťastia.
- Ako si vytvoriť **ranný rituál vďačnosti**, ktorý zvládneš aj počas bežného týždňa.
- Čo robiť, keď vďačnosť necítiš a nechceš sa do nej nútiť.
...
- V tejto chvíli som rád, že sedím.
- Som rád, že mám vodu.
- Pomohlo mi, že som sa dnes nemusel s nikým hádať.
- Uľavilo sa mi, keď som vyšiel na vzduch.
...
- Všímam si, že dýcham.
- Všímam si, že sedím v teple.
- Všímam si, že som dnes odpísal na jednu správu.
- Všímam si, že som sa osprchoval.
- Všímam si, že som vydržal deň bez výbuchu.
...
- Tento týždeň ma nabíjalo:
- Tento týždeň ma vyčerpávalo:
- Chcem viac:
- Chcem menej:
- Jeden malý krok:
