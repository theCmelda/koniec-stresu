...
- ako funguje **ako sa motivovať** bez závislosti na nálade
- prečo je **systém vs motivácia** zásadný rozdiel pre mentálnu výkonnosť
- ako začať keď sa nechce a znížiť odpor na prvých 10 minút práce
- čo má s motiváciou spoločné nervová sústava, dopamín, kortizol a regulácia
...
- **pevný štartovací čas** pre najdôležitejšiu úlohu
- **jedno pracovné okno** bez správ, mailov a sociálnych sietí
- **minimálny denný štandard**, ktorý splníš aj v slabý deň
- **koncový rituál**, aby mozog vedel, že cyklus je uzavretý
- **týždenný review**, kde upravíš systém podľa reality
...
- namiesto cvičiť: obuj si tenisky a urob 10 drepov
- namiesto písať článok: otvor dokument a napíš 5 zlých viet
- namiesto riešiť financie: otvor účet a skontroluj posledné 3 výdavky
- namiesto učiť sa: otvor poznámky a prečítaj prvú stranu
- namiesto upratať: vyhoď 10 vecí zo stola
...
- Ak je 8:00, potom otváram notebook a pracujem na jednej úlohe 25 minút.
- Ak prídem domov z práce, potom si hneď prezlečiem veci na tréning.
- Ak chytím mobil počas deep worku, potom ho položím do druhej miestnosti.
- Ak sa mi nechce, potom robím iba 10 minút.
...
- prvých 60 minút dňa bez sociálnych sietí
- mobil mimo pracovného stola počas deep worku
- notifikácie vypnuté natrvalo, nie len keď sa cítiš silný
- odmena až po pracovnom bloku, nie pred ním
- jeden nudný blok denne, kde netlačíš stimuláciu vyššie
...
- minimum: verzia, ktorú dáš aj v zlý deň
- štandard: verzia, ktorú chceš robiť väčšinu dní
- stretch: verzia, ktorú robíš, keď máš energiu a priestor

Napríklad pri písaní:

- minimum: 150 slov
- štandard: 45 minút sústredeného písania
- stretch: 2 hodiny deep worku a editácia
...
- Kde presne sa systém láme?
- Kedy počas dňa strácam energiu?
- Aká prekážka sa opakuje?
- Čo mi funguje, keď som bez motivácie?
- Ktorý prvý krok má najnižší odpor?
...
- koľko hodín spíš a aká je kvalita spánku
- kedy máš najčistejšiu hlavu
- po čom ti padá energia
- ktoré prostredie ti pomáha začať
- ktoré úlohy potrebuješ robiť v tichu a ktoré zvládneš v ľahšom režime
