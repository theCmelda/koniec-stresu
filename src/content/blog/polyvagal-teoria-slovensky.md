...
1. Polož jednu ruku na stred hrudníka, nie silno, len tak, aby telo cítilo kontakt.
2. Zníž pohľad alebo zavri oči, ak je to bezpečné.
3. Dýchaj o trochu pomalšie, než je tvoj automatický dych. Nemusíš robiť výkon z dýchania.
4. Predstav si, že nádych a výdych prechádza oblasťou hrudníka.
5. Na 60 až 90 sekúnd si vyber jednoduchý pocit alebo kvalitu: stabilita, pokoj, vďačnosť, rešpekt, teplo. Nie ako pozitívne myslenie, skôr ako smer pozornosti.
