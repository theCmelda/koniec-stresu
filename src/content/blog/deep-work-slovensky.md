...
readingTime: 12
videoId: x2UfgNlqZ5k
videoTitle: "Deep work pre slovenský kontext: ako brániť svoj fokus"
featured: false
...
- prečo **deep work** v slovenskom pracovnom kontexte zlyháva častejšie na hraniciach než na motivácii
- ako funguje **hlboká koncentrácia** z pohľadu neurovedy, stresu a nervovej sústavy
- **ako sa sústrediť**, keď máš otvorené notifikácie, tlak termínov a rozbehnutú hlavu
- ako použiť princípy **Cal Newport deep work** bez toho, aby si kopíroval americký akademický režim
- ako si vyskladať 5-krokovú meditačnú techniku na rýchle nastavenie pozornosti pred prácou
...
Jednotlivý blok je dobrý začiatok. Ale ak chceš, aby **deep work**pracoval aj v týždni, ktorý nie je ideálny, potrebuješ rytmus. Nie rigidný vojenský plán. Skôr operačný systém, ktorý vie absorbovať realitu bez toho, aby sa rozpadol pri prvom presune meetingu.

Začni týždenným auditom. V nedeľu večer alebo v pondelok ráno si polož tri otázky:

- Ktorá jedna vec by tento týždeň najviac posunula moju prácu?
- Kedy mám najvyššiu mentálnu energiu?
- Čo mi najpravdepodobnejšie rozbije pozornosť?
