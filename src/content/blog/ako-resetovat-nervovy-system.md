...
readingTime: 12
videoId: yEGfxyZGiiU
videoTitle: Ako resetovať nervový systém za víkend (a nezačať pondelok vyčerpaný)
featured: false
...
- ako resetovať nervový systém cez telo, rytmus a jednoduché regulačné návyky
- prečo **nervový systém reset** nezačína prázdnym kalendárom, ale správnymi signálmi pre telo
- ako nastaviť **regeneráciu za víkend**, aby pondelok nezačal vyčerpaním
- ako sa zregenerovať bez výčitiek, chaosu a prehnanej kompenzácie
...
- 30 minút bez obrazoviek po poslednej pracovnej správe
- krátka prechádzka bez podcastu
- jednoduché jedlo, nie trest za týždeň
- sprcha alebo sauna ako telesná hranica medzi prácou a víkendom
- spísanie otvorených slučiek na papier
...
- zapíš 3 veci, ktoré zostávajú otvorené
- ku každej napíš ďalší konkrétny krok
- vyber, čo nebudeš riešiť do pondelka
- fyzicky zatvor notebook, uprac stôl, prejdi sa
...
- scrolluješ 90 minút a cítiš sa prázdnejší
- dáš si alkohol, aby si vypol hlavu, ale spánok je plytký
- prespíš pol dňa, no stále máš napätie v tele
- zrušíš všetko, ale nevznikne pokoj, len izolácia

Regenerácia vyzerá inak:

- telo sa postupne uvoľní
- dych sa prehĺbi
- pozornosť sa stabilizuje
- máš viac kontaktu so sebou, nie menej
- po oddychu vieš urobiť lepšie rozhodnutie
...
- 10 minút shutdown rituál
- 20 až 40 minút chôdza
- ľahšie jedlo
- minimum obrazoviek pred spánkom
- žiadne riešenie veľkých životných otázok po 21:00

### Sobota: kapacita

- dopoludnia pohyb v zóne, kde vieš dýchať nosom
- jeden blok praktických vecí, nie celý deň povinností
- kvalitné jedlo s bielkovinami, sacharidmi a minerálmi
- kontakt s človekom, pri ktorom nemusíš hrať rolu
- jeden blok ticha alebo samoty

### Nedeľa: integrácia

- 15 minút reflexia týždňa
- 45 minút príprava na pondelok
- ľahký pohyb alebo mobilita
- skorší večer bez intenzívnych stimulov
- spánok ako priorita, nie ako zvyšok dňa
