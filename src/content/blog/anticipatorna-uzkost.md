...
1. **Spúšťač**: niečo ti pripomenie budúcu udalosť.  
2. **Telesný signál**: nervová sústava sa aktivuje.  
3. **Význam**: hlava dá signálu katastrofický príbeh.  
4. **Kontrola**: začneš skenovať telo, plánovať únik, vyhýbať sa.
...
4. **Pridaj konkrétny pocit bezpečia**  
