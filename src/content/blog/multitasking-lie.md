...
readingTime: 12
videoId: x2UfgNlqZ5k
videoTitle: "Multitasking lie: čo skutočne robíš keď „robíš všetko naraz“"
featured: false
...
1. **Jedna úloha**
   Vyberieš presne, čo ideš robiť. Nie pracovať na projekte, ale napísať prvých 600 slov landing page. Nie riešiť financie, ale skontrolovať cash-flow za posledných 30 dní.

2. **Jedno prostredie**
   Zatvoríš všetko, čo s úlohou nesúvisí. Telefón ide mimo zorného poľa. Slack je zavretý. Hudba, ak ju používaš, nesmie niesť ďalší obsah v slovách. Podcast pri písaní nie je background. Je to druhá kognitívna úloha.

3. **Jeden návratový bod**
   Keď sa stratíš, potrebuješ vedieť, kam sa vraciaš. Môže to byť veta na papieri: Teraz píšem návrh. Alebo timer na 30 minút. Alebo jedna otázka: Čo je najbližší konkrétny krok?
...
1. **Ukotvenie tela**
   Sadni si tak, aby chodidlá cítili zem. Uvoľni sánku, ramená a brucho. Nie nasilu. Len daj telu signál, že nemusí byť v obrane.

2. **Dych cez predĺžený výdych**
   Nadychuj sa nosom 3 až 4 sekundy, vydychuj 5 až 7 sekúnd. Predĺžený výdych podporuje parasympatikus a pomáha regulácii. Rob to 2 až 3 minúty.

3. **Zrakový bod**
   Vyber jeden bod pred sebou. Môže to byť roh stola, bodka na stene alebo plameň sviečky. Drž mäkký pohľad. Keď oči utekajú, vráť ich.

4. **Jedna veta**
   V duchu opakuj: Teraz som pri jednej veci. Nie ako afirmáciu. Ako navigáciu.

5. **Návrat k úlohe**
   Po meditácii hneď otvor jednu pripravenú úlohu. Nie telefón. Nie inbox. Jednu úlohu. Prvých 15 minút je súčasť tréningu.
