...
- ako môžu **prírodné alternatívy na spánok** podporiť návrat k prirodzenému zaspávaniu
- prečo je vedená nahrávka praktická **alternatíva Stilnox** pri dlhodobom riešení nespavosti
- čo robiť, keď chceš **bez tabliet zaspať**, ale telo je stále v pohotovosti
- ako vyzerá **prírodný spánok bez liekov** z pohľadu nervovej sústavy
- ktoré večerné návyky majú najväčší pákový efekt na kortizol, dopamín a regeneráciu
...
- Pusti si nahrávku každý večer v rovnakom časovom okne.
- Nedávaj si cieľ zaspať. Daj si cieľ iba dokončiť večerný proces.
- Ak zaspíš po 8 minútach, dobre. Ak po 35, stále trénuješ systém.
- Nepoužívaj nahrávku popri scrollovaní. To je konflikt signálov.
- Vyber si jednu nahrávku na 14 dní, nie každý večer novú.
...
- Vydýchni nosom alebo ústami na 6 až 8 dôb.
- Nerob to silou, skôr ako keby si pomaly zahmlieval sklo.
- Opakuj 5 minút.
- Ak sa objaví frustrácia, skráť počítanie a urob to ľahšie.
...
- Do 60 minút po zobudení choď na 5 až 15 minút von.
- Ak je zamračené, zostaň vonku dlhšie. Stále to funguje lepšie než svetlo cez okno.
- Po 20:30 stlm hlavné svetlá.
- Poslednú hodinu pred spaním zníž jas obrazoviek alebo ich odlož úplne.
- Ak vstávaš v noci, nepoužívaj ostré svetlo.
...
- Sadni si alebo ľahni a pomaly očami prechádzaj miestnosť.
- Pomenuj v hlave päť neutrálnych vecí, ktoré vidíš.
- Všimni si, kde máš oporu tela.
- Polož jednu ruku na hrudník alebo brucho a sleduj kontakt.
- Povedz si jednoducho: teraz som tu, v tejto miestnosti, túto noc nemusím riešiť celý život.
