...
1. **Orientácia v priestore**: pozri sa pomaly okolo seba, pomenuj päť vecí, ktoré vidíš. Telo dostáva signál, že tu a teraz je bezpečie.
2. **Dlhší výdych**: nádych nosom na 4, výdych na 6 až 8. Výdych aktivuje parasympatikus.
3. **Kontakt s telom**: chodidlá na zem, tlak dlaní o stehná, uvoľnená čeľusť.
4. **Zníženie vstupov**: menej obrazoviek, menej hluku, menej mentálneho prepínania, keď cítiš preťaženie.
...
1. Som mimo seba, reaktívny, preťažený.
2. Fungujem, ale idem na hrane.
3. Som stabilný, no potrebujem vedomé pauzy.
4. Mám kapacitu, viem reagovať s odstupom.
