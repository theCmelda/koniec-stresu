...
- prečo otázka **prečo som stále unavený** často nesúvisí len so spánkom
- aké sú **stála únava príznaky**, ktoré si high-performeri často racionalizujú
- prečo môže vzniknúť **chronická únava** z preťaženého sympatikusu, nie z lenivosti
- ako zistiť, **prečo som unavený aj po spánku**, cez jednoduchý energetický audit
- ako pracovať s telom, nervovou sústavou a regeneráciou bez ezoteriky a bez paniky
...
- ráno sa budíš bez pocitu obnovy
- poobede potrebuješ kofeín, cukor alebo scrollovanie
- jednoduché rozhodnutia ťa stoja neprimerane veľa energie
- máš napätie v čeľusti, ramenách alebo bruchu
- večer si unavený, ale hlava je stále aktívna
- máš menšiu toleranciu na hluk, ľudí a malé problémy
- regenerácia po tréningu, práci alebo konflikte trvá dlhšie
...
- výrazná únava aj po minimálnej námahe
- dýchavičnosť, búšenie srdca alebo závraty
- nevysvetliteľné chudnutie alebo priberanie
- nočné potenie, teploty alebo bolesti
- náhla zmena nálady, záujmu alebo motivácie
- chrápanie, prebúdzanie sa s dusením alebo ranné bolesti hlavy
